    ...
    <header class="container">
        <div class="row bg-light p-3 my-3 shadow rounded">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner ps-0 ps-lg-5">
                        <div class="carousel-item active">
                            <img src="/IMG/Abarrotera/Carrusel-Abarrotera-1.jpg" class="img-fluid d-block" width="400px" loading="lazy">
                        </div>
                        <div class="carousel-item">
                            <img src="/IMG/Abarrotera/Carrusel-Abarrotera-2.jpg" class="img-fluid d-block" width="400px" loading="lazy">
                        </div>
                        <div class="carousel-item">
                            <img src="/IMG/Abarrotera/Carrusel-Abarrotera-3.jpg" class="img-fluid d-block" width="400px" loading="lazy">
                        </div>
                        <div class="carousel-item">
                            <img src="/IMG/Abarrotera/Carrusel-Abarrotera-3.jpg" class="img-fluid d-block" width="400px" loading="lazy">
                        </div>
            ...
            <div class="col-12 col-lg-4 d-flex flex-column bd-highlight ">
                <p class="display-5 titulo text-center">Abarrotera</p>
                <hr>
                <p class="h1 texto text-center lh-5 pt-3 ">Atiende, Registra y Cobra. <br><span class="h2">Todo en un solo software</span></p>
