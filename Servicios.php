...
<?php require('NavBar.php') ?>
    <header class="container">
        <div class="col-12">
            <p class="display-4 text-center titulo mt-1">Servicios <hr> </p>
            <h2 class="text-center texto" style="color: #E5BE51;">Accede a la automatización de tu negocio</h1>
        </div>
    </header>
    
    <section class="container ">
        <div class="row align-items-center justify-content-lg-center mt-3">
    ...
    <main class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="titulo text-center mb-4">¡Obtén tu licencia de raptorsoft hoy mismo!</h2>
            </div>
        </div>
        <!-- TABLA -->
                    ...
                    <table class="table table-sm table-borderless">
                        ...
                        <tbody class="shadow">
                            <tr>
                                ...
                                <td class="table-primary p-3"><img class="" src="/IMG/check2-circle.svg" width="25px" alt=""></td>
                            ...
                            <tr>
                                ...
                                <td class="table-warning p-3"><img src="/IMG/check2-circle.svg" width="25px" alt=""></td>
                                <td class="table-primary p-3"><img src="/IMG/check2-circle.svg" width="25px" alt=""></td>
                                <td class="table-muted"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-tools" width="50px" height="48" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
