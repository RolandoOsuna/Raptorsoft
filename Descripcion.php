    ...
    <header class="container">
        <div class="row bg-light p-3 my-3 shadow rounded">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner ps-5">
                        <div class="carousel-item active">
                            <img src="/IMG/Abarrotes/Carrusel-Descripcion1.jpg" class="d-block" width="80%" loading="lazy">
                        </div>
                        <div class="carousel-item">
                            <img src="/IMG/Abarrotes//Carrusel-Descripcion2.jpg" class="d-block" width="80%" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="/IMG/Abarrotes/Carrusel-Descripcion3.jpg" class="d-block" width="80%" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="/IMG/Abarrotes/Carrusel-Descripcion4.jpg" class="d-block" width="80%" alt="...">
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-4 align-self-center">
                <p class="display-5 titulo text-center">Abarrotes</p>
                <hr>
